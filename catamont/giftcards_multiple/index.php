	...
	if($REQ_PARAM->action=="generate")
	{
		...
		else	
		{
			if($responseArr['email_sent']==true)
				$successMessage="Gift Card Details has been sent on the Email ID entered by you.
";
			if($responseArr['sms_sent']==true)
				$successMessage.="</br>Gift Card Details has been sent on the Mobile Number entered by you.";
