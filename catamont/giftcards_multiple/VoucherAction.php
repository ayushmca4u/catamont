...
class VoucherAction
{
	...
	public function generate_voucher($request)
	{
		...
		{
			$SMS_TEMPLATE=$CLIENT_SMS_TEMPLATE[$client_id];
			if($SMS_TEMPLATE=="")
			{
				$LOG_FILE_HANDLER->logging('ERROR',"Misisng SMS Template for client : $client_id");
	...
	function Get_Email_template($inputArr)
	{
		$email_template="";
		$email_template.="<div>Dear ICICI Customer, </br>
                                        <p>You have received a Flipkart Gift Cards of Rs ".$inputArr['flipcart_voucher_price']." valid up to ".$inputArr['flipcart_expiry_date']."</p></div>";
		...
		$email_template.="<table border=1 width='100%'>";
                ...
                $email_template.="<tr><td width='40%' align='center'>".$inputArr['flipcart_voucher_code']."</td><td width='30%' align='center'>".$inputArr['flipcart_voucher_pin']."</td><td width='30%' align='center'>".$inputArr['flipcart_voucher_price']."</td></tr>";
                $email_template.="</table>";
                $email_template.="</td></tr>";
                $email_template.="<tr style='background-color:#A9A9A9;align=center'><td>&nbsp;</td></tr>";
                $email_template.="<tr><td>*Pins generated at ".$inputArr['flipcart_purchase_date']."</td></tr>";
